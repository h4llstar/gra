...
run(function()
	...
	local Profile
	local Users
	local blacklistedclans = {'gg', 'gg2', 'koala'}
	local blacklisteduserids = {1502104539, 3826146717, 4531785383, 1049767300, 4926350670, 653085195, 184655415, 2752307430, 5087196317, 5744061325, 1536265275, 3421914799, 552317799, 4027407573}
	local joined = {}
